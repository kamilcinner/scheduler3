...
import { UpdateShoppingListItemsDto, UpdateShoppingListItemsResponseDto } from '../dto';
...
export const SelectedShoppingListItemsApiActions = createActionGroup({
  ...
  events: {
    ...
    'Update items success': props<{ dto: UpdateShoppingListItemsResponseDto }>(),
    'Update items failure': props<{ error: HttpErrorResponse | Error }>(),
    'Toggle item bought success': props<{ updatedItem: ShoppingListItemModel }>(),
